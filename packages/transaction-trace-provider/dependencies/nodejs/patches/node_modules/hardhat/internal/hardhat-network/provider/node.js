...
class HardhatNode extends events_1.default {
    ...
    static async create(config) {
        const { automine, genesisAccounts, blockGasLimit, tracingConfig, minGasPrice, mempoolOrder, networkId, chainId, allowBlocksWithSameTimestamp, } = config;
...
Hardhat Network's forking functionality only works with blocks from at least spuriousDragon.`);
    ...
    async _runInBlockContext(blockNumberOrPending, action) {
        ...
        try {
            ...
            log('Failed to run action in block context', e)
            throw e
        }
        finally {
