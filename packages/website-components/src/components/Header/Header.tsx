    ...
    <>
      ...
      <StyledHeader>
        <Section width="normal">
          <StyledWrapper direction="row" justifyContent="space-between" alignItems="center">
            <Logo algeaTheme />
            <StyledTextContainer direction="row" justifyContent="space-around" alignItems="center">
              <div onMouseEnter={() => setServicesHover(true)} onMouseLeave={() => setServicesHover(false)}>
                <MenuItemIcon
                  onTouchStart={() => {
              ...
              <div onMouseEnter={() => setCareersHover(true)} onMouseLeave={() => setCareersHover(false)}>
                <MenuItemIcon
                  onTouchStart={() => {
              ...
              <div onMouseEnter={() => setResourceHover(true)} onMouseLeave={() => setResourceHover(false)}>
                <MenuItemIcon
                  onTouchStart={() => {
