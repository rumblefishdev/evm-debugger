...
import type { TAddLogMessagePayload, TLogMessageRecord, TStageRecord } from './analyzer.types'
...
export const analyzerSliceReducer = analyzerSlice.reducer
export const analyzerSliceActions = analyzerSlice.actions

export type TAnalyzerActions = ActionsType<typeof analyzerSliceActions>
