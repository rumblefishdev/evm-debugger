...
export class NestedMap {
    ...
    private placeBlock(item: TTraceLog, index: number) {
        ...
        const blockData = { ...item, y: this.currentHeight - this.margin, x: this.currentWidth - this.margin } as TParsedExtendedTraceLog
        ...
        this.stageBlocks.forEach((block, blockIndex) => {
            ...
            if (isVertical) {
                ...
                this.placedBlocks[rootIndex] = { ...block, y, width: blockData.width, height }
            }
            if (!isVertical) {
                ...
                this.placedBlocks[rootIndex] = { ...block, x, width, height: blockData.height }
            }
        })
